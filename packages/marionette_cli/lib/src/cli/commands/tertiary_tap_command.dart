...
class TertiaryTapCommand extends InstanceCommand {
  TertiaryTapCommand(this._registry) {
    argParser
      ...
      ..addOption('x', help: 'X coordinate for positional tertiary tap.')
      ..addOption('y', help: 'Y coordinate for positional tertiary tap.');
  }
  ...
  @override
  String get name => 'tertiary-tap';

  @override
  String get description =>
      'Tertiary (middle mouse button) tap an element by key, text, type, '
      'or coordinates. Desktop only; triggers onTertiaryTap.';
  ...
  Future<int> execute(VmServiceConnector connector) async {
    ...
    final message =
        response['message'] as String? ?? 'Successfully tertiary tapped';
